...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_COLEMAK_GAME] = LAYOUT(
     ...
     KC_LSFT, KC_Z, KC_X, KC_C, KC_D, KC_V , KC_LCTL, KC_LALT,     _______, _______, KC_K, KC_H, KC_COMM, KC_DOT, KC_SLSH, KC_MINS,
               KC_EQL, _______, KC_ESC, KC_SPC , KC_TAB   ,     FUN_ENT, NUM_BSP, SYM_DEL, QWTY_FM, KC_F12
    ),
    ...
    [_QWERTY_GAME] = LAYOUT(
     ...
     KC_LSFT, KC_B, KC_Z, KC_X, KC_C, KC_V ,  KC_LBRC,KC_CAPS,     FKEYS  ,KC_RBRC, KC_N,   KC_M ,KC_COMM, KC_DOT ,KC_SLSH, KC_MINS,
               KC_EQL, _______, KC_ESC, KC_SPC , KC_TAB   ,     FUN_ENT, NUM_BSP, SYM_DEL, COLEMAK, KC_F12
    ),


    [_NUM] = LAYOUT(
     KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,                                       KC_LOCK ,KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, QK_BOOT,
     KC_TRNS, KC_RBRC, KC_7,    KC_8,    KC_9,    KC_LBRC,                                       KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
     KC_TRNS, KC_SCLN, KC_4,    KC_5,    KC_6,    KC_EQL,                                        KC_TRNS, KC_LSFT, KC_LCTL, KC_LALT, KC_LQUI, KC_TRNS,
    ...
    [_SYM] = LAYOUT(
     ...
     KC_TRNS, KC_COLN, KC_DLR,  KC_PERC, KC_CIRC, KC_PLUS,                                       KC_TRNS, KC_LSFT, KC_LCTL, KC_LALT, KC_LQUI, KC_TRNS,
    ...
    [_FN] = LAYOUT(
     ...
     KC_TRNS, KC_F11,  KC_F4,   KC_F5,   KC_F6,   KC_TRNS,                                       KC_TRNS, KC_LSFT, KC_LCTL, KC_LALT, KC_LQUI, KC_TRNS,
    ...
    [_NAV] = LAYOUT(
     QK_BOOT, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_LOCK,                                       KC_TRNS ,KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
    ...
    [_MEDIA] = LAYOUT(
     QK_BOOT, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_LOCK,                                       KC_TRNS ,KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
     KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,                                       UG_TOGG, UG_NEXT, UG_HEHU, UG_SATU, UG_VALU, KC_TRNS,
